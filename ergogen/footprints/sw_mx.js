    ...
    function pins(def_neg, def_pos, def_side) {
      if(p.hotswap) {
        ...
        `
          ...
          return `
            ${''/* pins */}
            (pad 1 thru_hole circle (at ${def_pos}2.54 -5.08) (size 2.25 2.25) (drill 1.47) (layers *.Cu *.Mask) ${p.from.str})
            (pad 2 thru_hole circle (at ${def_neg}3.81 -2.54) (size 2.25 2.25) (drill 1.47) (layers *.Cu *.Mask) ${p.to.str})
          `
      }
    }
    if(p.reverse){
