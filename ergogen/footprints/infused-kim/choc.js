...
module.exports = {
    ...
    body: p => {
        ...
        const hotswap_front = `
            ${'' /* Silkscreen outline */}
            (fp_line (start 7 -7) (end 7 -6) (layer Dwgs.User) (width 0.15))
            (fp_line (start 1.5 -8.2) (end 2 -7.7) (layer Dwgs.User) (width 0.15))
            (fp_line (start 7 -1.5) (end 7 -2) (layer Dwgs.User) (width 0.15))
            (fp_line (start -1.5 -8.2) (end 1.5 -8.2) (layer Dwgs.User) (width 0.15))
            (fp_line (start 7 -7) (end 6 -7) (layer Dwgs.User) (width 0.15))
            (fp_line (start 7 -6.2) (end 2.5 -6.2) (layer Dwgs.User) (width 0.15))
            (fp_line (start 2.5 -2.2) (end 2.5 -1.5) (layer Dwgs.User) (width 0.15))
            (fp_line (start -2 -7.7) (end -1.5 -8.2) (layer Dwgs.User) (width 0.15))
            (fp_line (start -1.5 -3.7) (end 1 -3.7) (layer Dwgs.User) (width 0.15))
            (fp_line (start 7 -5.6) (end 7 -6.2) (layer Dwgs.User) (width 0.15))
            (fp_line (start 2 -6.7) (end 2 -7.7) (layer Dwgs.User) (width 0.15))
            (fp_line (start 2.5 -1.5) (end 7 -1.5) (layer Dwgs.User) (width 0.15))
            (fp_line (start -2 -4.2) (end -1.5 -3.7) (layer Dwgs.User) (width 0.15))
            (fp_arc (start 2.499999 -6.7) (end 2 -6.690001) (angle -88.9) (layer Dwgs.User) (width 0.15))
            (fp_arc (start 0.97 -2.17) (end 2.5 -2.17) (angle -90) (layer Dwgs.User) (width 0.15))
        ...
        const hotswap_back = `
            ...
            (fp_line (start -7 -1.5) (end -7 -2) (layer Dwgs.User) (width 0.15))
            (fp_line (start -7 -6.2) (end -2.5 -6.2) (layer Dwgs.User) (width 0.15))
            (fp_arc (start -0.91 -2.11) (end -0.8 -3.7) (angle -90) (layer Dwgs.User) (width 0.15))
            (fp_arc (start -2.55 -6.75) (end -2.52 -6.2) (angle -90) (layer Dwgs.User) (width 0.15))

            ${'' /* Right Pad (cut off) */}
            (pad 1 smd custom (at 3.275 -5.95 ${p.rot}) (size 0.5 0.5) (layers F.Cu F.Paste F.Mask)
                (zone_connect 0)
                (options (clearance outline) (anchor rect))
                (primitives
                (gr_poly (pts
